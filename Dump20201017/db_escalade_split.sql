...
CREATE TABLE `split` (
  ...
  `longuer_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKqrjnsn3e39kci6sldh3fa5fbv` (`longuer_id`),
  CONSTRAINT `FKqrjnsn3e39kci6sldh3fa5fbv` FOREIGN KEY (`longuer_id`) REFERENCES `longeur` (`id`)
